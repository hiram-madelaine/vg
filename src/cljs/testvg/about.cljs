...
(defn about-page []
  [:article {:class "container"}
   ...
   [:article
    ...
    [:section
     "I reused the startable-component defined in the Test-3 tp produce a generic \"startable-graph-component\". To produce a new graph the important part is to create a function that crunches the data returned by the API and mutates the Chart accordingly."]]])
